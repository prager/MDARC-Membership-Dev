            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                  <ul class="nav nav-pills m-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#all_mems" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">All Members</button>
                    </li>
                  </ul>
                <div class="tab-content m-1" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="all_mems" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <table class="table table-hover table-bordered">
                      <thead>
                        <tr>
                          <th>Name</th>
